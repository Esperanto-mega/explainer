...
parser.add_argument("--num_layers", type = int, default = 2, help = "GCN model layers")
...
explainer = Explainer(
    ...
    algorithm = GraphMaskExplainer(num_layers = args.num_layers, epochs = args.epochs, lr = args.lr).to(device),
